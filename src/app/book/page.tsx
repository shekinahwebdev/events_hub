        ...
        <section className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-10">
          <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-200 text-center">
            ...
            <p className="text-slate-600 mb-6">
              You have successfully booked a spot for{" "}
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-200">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Complete your booking to reserve your place at this event
            </p>
          </div>
          ...
          <form onSubmit={handleBook} className="mt-8 space-y-6">
            <div className="bg-slate-50 rounded-lg p-6 border border-slate-200">
              ...
              <div className="space-y-3 text-sm text-slate-700">
                <p>✓ I confirm that I will attend this event</p>
                <p>
                  ✓ A confirmation email will be sent to my registered email
                </p>
                <p>
                  ✓ I understand that my booking is confirmed and I commit to
                  attending
                </p>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isBooking || !eventDetails}
